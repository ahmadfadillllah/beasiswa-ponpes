        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('dashboard.index') }}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('admin') }}/assets/images/logo-sm.svg" alt="" height="24"> <span class="logo-txt">Ponpes</span>
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ route('profile.index') }}"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> Profile</a>
